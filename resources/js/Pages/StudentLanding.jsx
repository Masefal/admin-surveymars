...
export default function StudentLanding() {
        ...
        return (
            <div className="min-h-screen bg-gray-100 flex justify-center items-center font-sans">
                <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="font-bold text-gray-500">Mencari Kuis...</p>
                </div>
            </div>
        );
    }
    ...
    if (error || !quiz) {
        return (
            <div className="min-h-screen bg-gray-100 flex justify-center items-center font-sans p-6">
            ...
            <div className="w-full max-w-md bg-white min-h-screen flex flex-col shadow-sm relative">
                ...
                <main className="flex-1 flex flex-col p-6 overflow-y-auto">
                    ...
                    <div className="mb-10">
                        ...
                        <div className="flex gap-3">
                            <div className="flex items-center gap-2 bg-gray-50 px-4 py-2.5 rounded-xl border border-gray-100">
                                ...
                                <span className="text-sm font-bold text-gray-700">{quiz.questions?.length || 0} Soal</span>
                            </div>
                            <div className="flex items-center gap-2 bg-gray-50 px-4 py-2.5 rounded-xl border border-gray-100">
                                <Clock size={18} className="text-gray-400" />
                                <span className="text-sm font-bold text-gray-700">{quiz.time_limit_minutes} Menit</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-auto pt-6 border-t border-gray-50">
                        ...
                        <button 
                            onClick={handleStart}
                            className="w-full bg-[#1b6d39] hover:bg-[#14532b] text-white font-bold rounded-xl py-4 flex justify-center items-center gap-2 transition-all active:scale-[0.98]"
                        >
