        ...
        <AdminLayout>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="topik" value={formData.topik} onChange={handleChange} placeholder="Misal: Bangun Datar" className="w-full rounded-xl border border-gray-200 px-4 py-3 focus:border-[#1b6d39] focus:outline-none focus:ring-1 focus:ring-[#1b6d39]" />
                        </div>
                        <div>
                            <label className="block text-sm font-bold text-gray-900 mb-2">Deskripsi / Konteks untuk AI</label>
                            <input type="text" name="deskripsi" value={formData.deskripsi} onChange={handleChange} placeholder="Konteks soal (opsional)" className="w-full rounded-xl border border-gray-200 px-4 py-3 focus:border-[#1b6d39] focus:outline-none focus:ring-1 focus:ring-[#1b6d39]" />
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm h-fit">
                    ...
                    <button onClick={handleGenerate} disabled={loading || !formData.mapel || !formData.kelas} className="w-full bg-[#1b6d39] hover:bg-[#14532b] disabled:bg-gray-400 transition-colors text-white font-semibold py-3 px-6 rounded-xl flex items-center justify-center gap-2">
